...
type ComplexityRoot struct {
	...
	Query struct {
		GetTeamByUserID func(childComplexity int, teamID int) int
...
type QueryResolver interface {
	...
	GetTeamByUserID(ctx context.Context, teamID int) ([]*model.Player, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.getTeamByUserId":
		if e.complexity.Query.GetTeamByUserID == nil {
			break
		}

		args, err := ec.field_Query_getTeamByUserId_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.GetTeamByUserID(childComplexity, args["teamID"].(int)), true
	...
	case "Query.signUp":
		if e.complexity.Query.SignUp == nil {
			break
		}

		args, err := ec.field_Query_signUp_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}

		return e.complexity.Query.SignUp(childComplexity, args["username"].(string), args["password"].(string)), true
...
type Query {
  ...
  getTeamByUserId(teamID: Int!): [Player!]!
}`, BuiltIn: false},
}
...
func (ec *executionContext) field_Query_getTeamByUserId_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 int
...
func (ec *executionContext) field_Query_signUp_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 string
	if tmp, ok := rawArgs["username"]; ok {
...
func (ec *executionContext) _Query_signUp(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Query_signUp_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().SignUp(rctx, args["username"].(string), args["password"].(string))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_getTeamByUserId(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	ctx = graphql.WithFieldContext(ctx, fc)
	rawArgs := field.ArgumentMap(ec.Variables)
	args, err := ec.field_Query_getTeamByUserId_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().GetTeamByUserID(rctx, args["teamID"].(int))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	res := resTmp.([]*model.Player)
	fc.Result = res
	return ec.marshalNPlayer2ᚕᚖgithubᚗcomᚋrytausᚋmobamanagerᚋserverᚋgraphᚋmodelᚐPlayerᚄ(ctx, field.Selections, res)
}
	...
	for i, field := range fields {
		...
		case "signUp":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_signUp(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
			})
		case "getTeamByUserId":
			field := field
			out.Concurrently(i, func() (res graphql.Marshaler) {
				defer func() {
					if r := recover(); r != nil {
				...
				res = ec._Query_getTeamByUserId(ctx, field)
				if res == graphql.Null {
					atomic.AddUint32(&invalids, 1)
				}
				return res
...
func (ec *executionContext) marshalNPlayer2ᚕᚖgithubᚗcomᚋrytausᚋmobamanagerᚋserverᚋgraphᚋmodelᚐPlayerᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Player) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNPlayer2ᚖgithubᚗcomᚋrytausᚋmobamanagerᚋserverᚋgraphᚋmodelᚐPlayer(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
